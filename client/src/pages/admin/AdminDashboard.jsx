        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">
              Administrator: {user?.name || 'Academic Administrator'}
            </p>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto p-6 sm:p-8 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <div>
              <h2 className="text-base font-bold text-slate-900">Active Clearance Registry</h2>
              <p className="text-xs text-slate-500 mt-0.5">Monitoring multi-department verification status</p>
            </div>
