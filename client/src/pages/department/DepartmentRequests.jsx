...
export default function DepartmentRequests() {
  ...
  return (
    <DepartmentPortalLayout title="Sports Clearance Requests">
      <section className="flex items-center justify-between rounded-xl border border-slate-200 bg-white p-5 shadow-sm"><div><p className="text-lg font-bold tracking-tight">Sports Clearance Requests</p><p className="mt-1 text-xs text-slate-500">Review requests assigned to the Sports Department.</p></div><span className="rounded-full bg-blue-50 px-3 py-1 text-[11px] font-semibold text-blue-700">Sports only</span></section>
